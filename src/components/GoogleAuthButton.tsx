  ...
  async function handleClick() {
    ...
    try {
      ...
      if (stage === "profile") {
        ...
        setError("Your browser blocked the sign-in popup. Please allow popups for this site and try again, or use your email and password below.");
        ...
        setError(`Something went wrong starting Google sign-in${code ? ` (${code})` : ""}. Please try again, or use your email and password below.`);
      }
      setBusy(false);
    }
  }
